...
custom_words = {'earthquake', 'mw', 'magnitude', 'which', 'the', 'km', 'ca', 'vs', 'mw', 'm', 'suggest', 
                'would', 'mmi', 'ridgecrest', 'meter', 'iv', 'may', 'v', 'this', 'generally', 'typically', 
                'vi', 'at', 'could', 'los', 'las', 'vegas', 'nv', 'san', 'vii', 'iii', 'also', 'californias',  
                'see', 'sq', 'often', 'fresno', 'to', 'are', 'and', 'in', 'which', 'unavailable', 'imply',
                'due', 'considering', 'californias', 'ridecrest', 'information', 'data', 'event', 'los', 'angelas',
                'these', 'two', 'iv'}
